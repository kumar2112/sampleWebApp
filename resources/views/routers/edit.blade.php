          ...
          <form action="{{route('router.update')}}" method="post"  id="updateRouterDataForm">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                 ...
                 <input value="{{$router->internet_host_name}}" type="text" class="form-control" id="txtInternetHostName" name="txtInternetHostName" aria-describedby="EmployeeNameHelp" placeholder="Host Name">
              ...
              <div class="form-group">
                ...
                <input value="{{$router->client_ip_address}}" type="text" class="form-control" id="txtClientIpAddress" name="txtClientIpAddress" placeholder="Ip Address">
              ...
              <div class="form-group">
                ...
                <input value="{{$router->mac_address}}" type="text" class="form-control" id="txtMacAddress" name="txtMacAddress" placeholder="Mac Address">
